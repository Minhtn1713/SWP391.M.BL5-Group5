...
public class AjaxServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("screens/EnterMoney.jsp").forward(request, response);
        }else{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.setCharacterEncoding("UTF-8");
            ...
            System.out.println("Amount parameter: " + amountParam); // Log amount parameter

            if (amountParam == null || amountParam.isEmpty()) {
                throw new IllegalArgumentException("Amount parameter is null or empty");
            }
        ...
        System.out.println("Parameters: " + vnp_Params);
