        ...
        <section class="product">
            <div class="top">
                <div class="search-box">
                    ...
                    <input type="text" id="storageSearch" placeholder="Search here..." />
                </div>
                    ...
                    <div class="boxes">
                        <div class="recent-order">
                            ...
                            <div class="product-add">
                                <a href="create-storage">Add new Storage</a>
                            </div>
                                            ...
                                            <tr class="storage-row">
                                                ...
                                                <td>
                                                    <c:if test="${c.status == 1}">
                                                        <a href="hide-storage?id=${c.id}&sta=2"><i class='bx bx-show-alt icon'></i></a>
                                                    </c:if>
                                                    <c:if test="${c.status != 1}">
                                                        <a href="hide-storage?id=${c.id}&sta=1"><i class='bx bx-low-vision icon'></i></a>
                                                    </c:if>
                                                </td>
                                            </tr>
                                        </c:forEach>
        ...
        <script>
            ...
            function filterRows() {
                ...
                let filteredRows = Array.from(rows).filter(row => {
                    const storageSize = row.querySelector('td:nth-child(2)').textContent.toLowerCase();
                    return storageSize.includes(filter);
                });
