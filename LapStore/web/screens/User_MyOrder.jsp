            ...
            <div class="profile-container">
                <div class="profile">
                    <div class="left-container">
                        ...
                        <a id="setting" class="left-line" href="/LapStore/account-profile?status=setting"><i class="fa fa-cog" aria-hidden="true"></i> Setting</a><br/><br/>
                        <a class="left-line" href="my-cart"><i class='fa fa-shopping-bag'></i> My order</a><br/><br/>
                    </div>
