                ...
                <div class="right">
                    <div class="right-sort">
                        <div class="current-showing">
                            <strong>Show</strong>
                            <form action="store" method="get" class="products-show-form">
                        ...
                        <form action="store" method="get" class="products-sort-by">
                    ...
                    <div class="pagination" id="pagination">
                        <c:if test="${currentPage > 1}">
                            <a href="store?page=${currentPage - 1}&items-per-page=${itemsPerPage}&sort-by=${sortBy}" class="pagination-link">Previous</a>
                        </c:if>
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <a href="store?page=${i}&items-per-page=${itemsPerPage}&sort-by=${sortBy}" class="pagination-link ${i == currentPage ? 'active' : ''}">${i}</a>
                        </c:forEach>
                        <c:if test="${currentPage < totalPages}">
                            <a href="store?page=${currentPage + 1}&items-per-page=${itemsPerPage}&sort-by=${sortBy}" class="pagination-link">Next</a>
                        </c:if>
                    </div>
                </div>
            </div>
