                        ...
                        <div class="boxes">
                            <div class="recent-order">
                                <div class="product-title">
                                    <i class='bx bx-news icon'></i>&nbsp;Order
                                </div>

                                <div class="row">
                                    <div class="col-lg-12 mt-4">
                                        <div class="card border-0 p-4 rounded shadow">
                                            <form class="mt-4" action="/LapStore_main/order/save?id=${order.id}" method="post" >
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">User</label>

                                                        <a href="/LapStore_main/user/update?id=${order.userId}" 
                                                           class="form-control btn btn-soft-success" 
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="phone" id="title" type="text" class="form-control " readonly value="${order.createdDate}">   
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="email" id="title" type="text" class="form-control " readonly placeholder="${order.name} (${order.phone}) ${order.address}">   
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>     
                                                        ...
                                                        <c:forEach items="${listP}" var="o">
                                                            ...
                                                            <td>${o.storage}</td>
                                                            <td>${o.quantity}</td>
                                                            <td>${(o.productPrice+o.variantPrice)*o.quantity} $</td>
                                                        </tr>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="status"  required>
                                                            ...
                                                            <option value="2" ${order.status==2 ? 'selected' : ''}>Awaiting Payment</option>
                                                            <option value="3" ${order.status==3 ? 'selected' : ''}>Awaiting Shipment</option>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="price" id="price" type="text" class="form-control " readonly placeholder="${totalPrice} $">   
                                                        <p class="text-danger">${errorEmail}</p>
                                                    </div>
                                                </div><!--end col-->
                                                </div>
